 ...
 */
public class ItfConfigBillVOQueryByPksAction implements ICommonAction {
  ...
  protected Object toBillData(PageQueryInfo info,
    ...
    int i = 0;
    for (AggItfConfigBillVO bill : bills) {
  ...
  private Collection<AggItfConfigBillVO> queryBills(PageQueryInfo queryParam)
    ...
    String wheresql =
        SQLUtil.buildSqlForIn("pk_itfconfigbill",queryParam.getPks());
    Collection<AggItfConfigBillVO> bills =
        service.queryBillOfVOByCond(AggItfConfigBillVO.class, wheresql, false,
            false);
    return bills;
  }
}
