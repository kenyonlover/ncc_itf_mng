...
public class CreateIABillVOImpl implements ICreateIABillVO {
	...
	public AggregatedValueObject createBillVO(HashMap<String, Object> nccBillMap, String pk_group)
		...
		String headclassid = "ec545ab9-8879-4df2-907d-8ea30c84b5f7";// 存货核算出库调整单表头元数据ID，需要通过语句查找最新版本元数据
		String bodyclassid = "58c068f9-de2a-4c61-ae1b-14bec140ee50";// 存货核算出库调整单元数据ID，需要通过语句查找最新版本元数据
...
//				headvo.setNtotalnum(totalnum);//总数量
			...
			e.printStackTrace();
			throw new BusinessException("转换存货核算出库调整单数据VO出错！" + e.getMessage());
		}
